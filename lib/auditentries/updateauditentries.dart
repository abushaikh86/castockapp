...
class UpdateAuditEntries extends StatefulWidget {
  ...
  UpdateAuditEntries(
      ...
      required this.selectedAuditId,
      required this.selectedEntryId});
  @override
  State<UpdateAuditEntries> createState() =>
      _UpdateAuditEntries(selectedCompanyId, selectedAuditId);
}
...
class _UpdateAuditEntries extends State<UpdateAuditEntries> {
  ...
  Widget build(BuildContext context) {
    final updateAuditEntries =
        ModalRoute.of(context)!.settings.arguments as AuditEntriesModel;
    ...
    totalAmount.text = updateAuditEntries.totalAmount ?? "";
    ...
    selectedFormat = getFormatName(
        updateAuditEntries.formatId!, updateAuditEntries.brandId!);
    selectedVariant = getVariantName(updateAuditEntries.variantId!,
        updateAuditEntries.brandId!, updateAuditEntries.formatId!);
    selectedWarehouse = getWarehouseName(
        updateAuditEntries.warehouseId!, updateAuditEntries.companyId!);
    selectedDescription = getDescriptionName(
        updateAuditEntries.productId!,
        updateAuditEntries.brandId!,
        updateAuditEntries.formatId!,
        updateAuditEntries.variantId!);
                    ...
                    child: DropdownSearch<String>(
                      ...
                      onChanged: (val) {
                        ...
                        setState(() {
                          ...
                          var descriptionRecord = db!.getDescriptionRecord(
                              brandId.text,
                              formatId.text,
                              variantId.text,
                              descriptionId.text);
                    ...
                    child: ElevatedButton(
                        onPressed: () {
                          ...
                          if (calculations != '') {
                            ...
                            calculationResult = calcActualUnit.evaluate(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                    onPressed: () async {
                      ...
                      String uAuditId = widget.selectedAuditId;
                      ...
                      String uValuationPerUnit =
                          valuationPerUnit.text.toString();
                      ...
                      dbHelper!
                          .update(AuditEntriesModel(
                        entryId: int.parse(widget.selectedEntryId),
                        auditId: uAuditId,
                        ...
                        constants.Notification(
                            "Audit Entry Updated Successfully");
