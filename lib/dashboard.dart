          ...
          children: [
              ...
              child: InkWell(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image(
                        image: AssetImage(constants.auditIcon),
                        width: 60,
                        height: 60,
                      ),
                      Text(
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => DataSync()));
                },
                child: Card(
                  color: Colors.white,
                  child: Column(
                    ...
                    children: [
                      Image(
                        image: AssetImage(constants.datasyncIcon),
                        width: 60,
                        height: 60,
                      ),
                      Text(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Image(
                        image: AssetImage(constants.brandIcon),
                        width: 60,
                        height: 60,
                      ),
                      Text(
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Formats()));
                },
                child: Card(
                  color: Colors.white,
                  child: Column(
                    ...
                    children: [
                      Image(
                        image: AssetImage(constants.formatIcon),
                        width: 60,
                        height: 60,
                      ),
                      Text(
              ...
              child: InkWell(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image(
                        image: AssetImage(constants.variantIcon),
                        width: 60,
                        height: 60,
                      ),
                      Text(
              ...
              child: InkWell(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image(
                        image: AssetImage(constants.descriptionIcon),
                        width: 60,
                        height: 60,
                      ),
                      Text(
              ...
              child: InkWell(
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image(
                        image: AssetImage(constants.warehouseIcon),
                        width: 60,
                        height: 60,
                      ),
                      Text(
