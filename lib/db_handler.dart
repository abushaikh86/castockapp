...
class DBHelper {
  ...
  _onCreate(Database db, int version) async {
    ...
    await db.execute(
        "CREATE TABLE IF NOT EXISTS audit (audit_id INTEGER PRIMARY KEY AUTOINCREMENT, company_id TEXT NULL, audit_description TEXT NULL, audit_status TEXT NULL)");
    await db.execute(
    ...
    await db.execute(
        "CREATE TABLE IF NOT EXISTS sync_date (sync_id INTEGER PRIMARY KEY AUTOINCREMENT, sync_code TEXT NULL, sync_date TEXT NULL)");
  }
